    ...
    const services = [
        {
            ...
            description: "No pagues de más. Compara entre más de 20 aseguradoras y encuentra la póliza perfecta para tu coche importado.",
            buttonText: "Comparar Seguros",
            link: "https://www.rastreator.com/seguros-coche", // Placeholder
            recommended: true
        },
        {
            icon: Wrench,
            title: "Garantía Mecánica",
            description: "Duerme tranquilo. Contrata una garantía mecánica europea que cubra cualquier avería imprevista en tu nuevo coche.",
        ...
        },
        {
            ...
            description: "¿Kilómetros reales? ¿Accidentes? No te la juegues. Saca el informe oficial antes de comprar.",
            buttonText: "Obtener Informe",
            link: "https://www.carfax.es/", // Placeholder
            recommended: false
        },
        {
            icon: Truck,
