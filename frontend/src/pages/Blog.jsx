        ...
        <div className="min-h-screen bg-slate-50 dark:bg-slate-950 pt-32 pb-20">
            ...
            <div className="container mx-auto px-4">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <span className="text-blue-600 dark:text-blue-400 font-bold tracking-widest uppercase text-sm bg-blue-50 dark:bg-blue-900/30 px-3 py-1 rounded-full border border-blue-100 dark:border-blue-800">
                        Blog & Recursos
                    </span>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {Array.isArray(blogPosts) && blogPosts.map((post, index) => (
                        <motion.article
                            ...
                            className="bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-sm hover:shadow-xl dark:hover:shadow-blue-900/10 transition-all duration-300 border border-slate-100 dark:border-slate-800 group flex flex-col h-full"
                        >
                            ...
                            <div className="p-6 flex flex-col flex-grow">
                                ...
                                <Link
                                    to={`/blog/${post.slug}`}
                                    className="inline-flex items-center text-blue-600 dark:text-blue-400 font-bold text-sm hover:text-blue-800 dark:hover:text-blue-300 transition-colors mt-auto"
                                >
                ...
                {/* CTA Section */}
                <div className="mt-20 bg-slate-900 dark:bg-slate-900/50 rounded-3xl p-8 md:p-12 text-center relative overflow-hidden ring-1 ring-white/10">
                    ...
                    <div className="relative z-10 max-w-2xl mx-auto">
                        ...
                        <Link
                            to="/"
                            className="inline-block bg-white text-slate-900 font-bold py-3 px-8 rounded-xl hover:bg-blue-50 transition-colors shadow-lg"
                        >
                            Ir al Analizador
                        </Link>
                    </div>
