                    ...
                    <div className="p-10 md:p-16 space-y-12 text-slate-600 dark:text-slate-400 leading-relaxed">
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6 flex items-center">
                                <span className="w-8 h-8 rounded-lg bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mr-3 text-sm font-bold">1</span>
                                Identificación
                            </h2>
                            <div className="bg-slate-50 dark:bg-slate-800/50 rounded-2xl p-6 border border-slate-100 dark:border-slate-700/50">
                                ...
                                <p className="font-medium text-slate-900 dark:text-white text-lg">UNAI SANCHEZ PEREYRA</p>
                                <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 mt-4 text-sm">
                                    <div>
                                        <span className="font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest text-xs block mb-1">NIF</span>
                                        <span className="text-slate-900 dark:text-white font-medium">49575893Z</span>
                                    </div>
                                    <div>
                                        <span className="font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest text-xs block mb-1">Domicilio</span>
                                        <span className="text-slate-900 dark:text-white font-medium">Donostia, Gipuzkoa</span>
                                    </div>
                                </div>
                            </div>
                        </section>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6 flex items-center">
                                <span className="w-8 h-8 rounded-lg bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mr-3 text-sm font-bold">2</span>
                                Objeto
                            </h2>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6 flex items-center">
                                <span className="w-8 h-8 rounded-lg bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mr-3 text-sm font-bold">3</span>
                                Uso del Sitio Web
                            </h2>
                            ...
                            <ul className="space-y-3">
                                {[
                                    ...
                                    <li key={i} className="flex items-start">
                                        <AlertCircle size={18} className="text-red-400 dark:text-red-500 mr-3 mt-0.5 flex-shrink-0" />
                                        <span>{item}</span>
                                    </li>
                                ))}
                            </ul>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6 flex items-center">
                                <span className="w-8 h-8 rounded-lg bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mr-3 text-sm font-bold">4</span>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6 flex items-center">
                                <span className="w-8 h-8 rounded-lg bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 flex items-center justify-center mr-3 text-sm font-bold">5</span>
                                Exclusión de Garantías y Responsabilidad
                            </h2>
                            <div className="bg-orange-50 dark:bg-orange-900/20 border-l-4 border-orange-400 dark:border-orange-500 p-6 rounded-r-xl space-y-4">
                                ...
                                <div className="flex items-start gap-3">
                                    <CheckCircle size={20} className="text-orange-500 dark:text-orange-400 mt-0.5 flex-shrink-0" />
