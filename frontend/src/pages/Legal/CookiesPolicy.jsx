                    ...
                    <div className="p-10 md:p-16 space-y-12 text-slate-600 dark:text-slate-400 leading-relaxed">
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6 flex items-center">
                                <span className="w-8 h-8 rounded-lg bg-amber-50 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 flex items-center justify-center mr-3 text-sm font-bold">1</span>
                                ¿Qué son las cookies?
                            </h2>
                            <div className="flex items-start gap-4 bg-slate-50 dark:bg-slate-800/50 p-6 rounded-2xl border border-slate-100 dark:border-slate-700/50">
                                <Info size={24} className="text-slate-400 dark:text-slate-500 flex-shrink-0 mt-1" />
                                <p>
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6 flex items-center">
                                <span className="w-8 h-8 rounded-lg bg-amber-50 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 flex items-center justify-center mr-3 text-sm font-bold">2</span>
                                ¿Qué tipos de cookies utiliza esta web?
                            </h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="bg-white dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700/50 p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                                    ...
                                    <h3 className="font-bold text-slate-900 dark:text-white mb-2">Cookies Técnicas</h3>
                                ...
                                <div className="bg-white dark:bg-slate-800/50 border border-slate-100 dark:border-slate-700/50 p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                                    ...
                                    <h3 className="font-bold text-slate-900 dark:text-white mb-2">Cookies de Análisis</h3>
                                    <p className="text-sm text-slate-500 dark:text-slate-400">
                        ...
                        <section>
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-6 flex items-center">
                                <span className="w-8 h-8 rounded-lg bg-amber-50 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 flex items-center justify-center mr-3 text-sm font-bold">3</span>
                            ...
                            <div className="space-y-3">
                                {[
                                    ...
                                    <div key={i} className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-700/50">
                                        <span className="font-bold text-slate-900 dark:text-white">{item.browser}</span>
                                        <span className="text-xs text-slate-500 dark:text-slate-400 font-mono bg-white dark:bg-slate-700 px-2 py-1 rounded border border-slate-200 dark:border-slate-600">{item.path}</span>
                                    </div>
                                ))}
                            </div>
                        </section>
