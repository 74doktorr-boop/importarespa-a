    ...
    return (
        <>
            <motion.nav
                ...
                className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white/90 dark:bg-slate-900/90 backdrop-blur-md shadow-sm py-3' : 'bg-transparent py-5'
                    }`}
            >
                <div className="container mx-auto px-6 max-w-7xl flex items-center justify-between">
                    ...
                    >
                        ...
                        <div className="flex flex-col items-start">
                            <span className={`font-serif font-bold text-lg tracking-tight leading-none ${isScrolled ? 'text-slate-900 dark:text-white' : 'text-slate-900 dark:text-white'}`}>
                                IMPORTAR ESPAÑA
                            </span>
                    ...
                    <div className="hidden md:flex items-center gap-1">
                        ...
                        <div className={`w-px h-6 mx-4 ${isScrolled ? 'bg-slate-200 dark:bg-slate-700' : 'bg-slate-300 dark:bg-slate-600'}`}></div>
                        ...
                        <button
                            ...
                            className="relative flex items-center gap-2 px-5 py-2.5 rounded-xl bg-slate-900 dark:bg-blue-600 hover:bg-slate-800 dark:hover:bg-blue-700 text-white transition-all shadow-lg shadow-slate-900/10 active:scale-95"
                        >
            ...
            < AnimatePresence >
                {isMobileMenuOpen && (
                    <motion.div
                        ...
                        exit={{ opacity: 0, y: -20 }}
                        className="fixed inset-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl pt-24 px-6 md:hidden"
                    >
                        <div className="flex flex-col gap-4">
                            <div className="flex items-center justify-between mb-2">
                                <span className="text-xs font-bold uppercase tracking-widest text-slate-400">Tema</span>
                                <ThemeToggle />
                            </div>
